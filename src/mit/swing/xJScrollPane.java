...
public class xJScrollPane extends javax.swing.JScrollPane implements mit.awt.event.ComponentRaiser, mit.awt.event.ContainerRaiser, mit.awt.event.FocusRaiser, mit.awt.event.KeyRaiser, mit.awt.event.MouseRaiser
{
	...
	public xJScrollPane(java.awt.Container owner)
	{
		super();
		this.owner = owner;
	}

	public xJScrollPane(java.awt.Container owner, java.awt.Component view)
	{
		super(view);
		this.owner = owner;
	}

	public xJScrollPane(java.awt.Container owner, java.awt.Component view, int vsbPolicy, int hsbPolicy)
	{
		super(view, vsbPolicy, hsbPolicy);
		this.owner = owner;
	}

	public xJScrollPane(java.awt.Container owner, int vsbPolicy, int hsbPolicy)
	{
