...
public class xJWindow extends javax.swing.JWindow implements mit.awt.event.ComponentRaiser, mit.awt.event.ContainerRaiser, mit.awt.event.FocusRaiser, mit.awt.event.KeyRaiser, mit.awt.event.MouseRaiser, mit.awt.event.WindowRaiser
{
	...
	public xJWindow(java.awt.Window owner)
	{
		super();
		this.owner = owner;
	}

	public xJWindow(java.awt.Window owner, javax.swing.JFrame frame)
	{
		super(frame);
		this.owner = owner;
	}

	public xJWindow(java.awt.Window owner, java.awt.GraphicsConfiguration gc)
	{
		super(gc);
		this.owner = owner;
	}

	public xJWindow(java.awt.Window owner, javax.swing.JWindow window)
	{
		super(window);
		this.owner = owner;
	}

	public xJWindow(java.awt.Window owner, javax.swing.JWindow window, java.awt.GraphicsConfiguration gc)
	{
		super(window, gc);
		this.owner = owner;
	}
