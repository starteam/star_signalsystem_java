...
public class xJScrollBar extends javax.swing.JScrollBar implements mit.awt.event.AdjustmentRaiser, mit.awt.event.ComponentRaiser, mit.awt.event.FocusRaiser, mit.awt.event.KeyRaiser, mit.awt.event.MouseRaiser
{
	...
	{
		return adjustment.getAdjustmentEvent();
	}
	...
	protected mit.awt.event.AdjustmentAdapter adjustment = new mit.awt.event.AdjustmentAdapter(this);
