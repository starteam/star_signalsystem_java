...
public class xJFrame extends javax.swing.JFrame implements mit.awt.event.ComponentRaiser, mit.awt.event.ContainerRaiser, mit.awt.event.FocusRaiser, mit.awt.event.KeyRaiser, mit.awt.event.MouseRaiser, mit.awt.event.WindowRaiser
{
	...
	public xJFrame(java.awt.Window owner)
	{
		super();
		this.owner = owner;
	}

	public xJFrame(java.awt.Window owner, java.awt.GraphicsConfiguration gc)
	{
		super(gc);
		this.owner = owner;
	}

	public xJFrame(java.awt.Window owner, String title)
	{
		super(title);
		this.owner = owner;
	}

	public xJFrame(java.awt.Window owner, String title, java.awt.GraphicsConfiguration gc)
	{
		super(title, gc);
		this.owner = owner;
	}
